...
class QRSDetectorOffline(object):
    def __init__(self, ecg_data_path, verbose=True, log_data=False, plot_data=False, show_plot=False):
        ...
        self.detect_peaks()
        self.detect_qrs()
        # self.filtered_ecg_measurements = self.filtered_ecg_measurements.astype(
        #     'float')
        # print(self.filtered_ecg_measurements.max(),
        #       self.filtered_ecg_measurements.dtype)
        # print(self.filtered_ecg_measurements,
        #       self.filtered_ecg_measurements.shape)
        # print(self.differentiated_ecg_measurements)
    ...
    def bandpass_filter(self, data, lowcut, highcut, signal_freq, filter_order):
        ...
        low = (lowcut / nyquist_freq) + 0.00000000001
